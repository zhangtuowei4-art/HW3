...
# --- IGL Compatibility Patch (Safe Dummy Functions) ---
def fast_winding_number_for_meshes(*args, **kwargs): pass
def point_mesh_squared_distance(*args, **kwargs): pass
def read_obj(*args, **kwargs): pass
# ------------------------------------------------------
